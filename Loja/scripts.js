...
function carregarCliente( obj ) {
	...
	xhttp.onreadystatechange = function() {
    	if (this.readyState == 4 && this.status == 200) {
      		...
      		document.getElementById('codigo').value 	= resultado[0].codigo;
      		document.getElementById('categoria').value 	= resultado[0].categoria;
      		document.getElementById('preco').value 	        = resultado[0].preco;
      		document.getElementById('estoque').value 	= resultado[0].estoque;
      		document.getElementById('peso').value 	        = resultado[0].peso;
      		document.getElementById('descricao').value 	= resultado[0].descricao;
      		document.getElementById('inclusao').value 	= resultado[0].inclusao;
      		document.getElementById('status').value 	= resultado[0].status;
...
function salvarForm() {
	...
	xhttp.onreadystatechange = function() {
  	...
  	formData.append("inclusao", document.getElementById("inclusao").value);
